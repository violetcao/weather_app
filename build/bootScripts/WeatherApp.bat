...
set JARPATH=%APP_HOME%\lib\WeatherApp-1.0-SNAPSHOT.jar

@rem Execute WeatherApp
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEATHER_APP_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%WEATHER_APP_EXIT_CONSOLE%" exit 1
exit /b 1
